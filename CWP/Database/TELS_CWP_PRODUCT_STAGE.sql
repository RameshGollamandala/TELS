DROP TABLE TELS_CWP_PRODUCT_STAGE CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_PRODUCT_STAGE
(
...
CREATE UNIQUE INDEX TELS_STAGE_PRODUCT_PK ON TELS_CWP_PRODUCT_STAGE
