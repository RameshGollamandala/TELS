DROP TABLE TELS_CWP_OPPORTUNITY_PRESTAGE CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_OPPORTUNITY_PRESTAGE
(
...
CREATE UNIQUE INDEX TELS_PRESTAGE_OPPORTUNITY_PK ON TELS_CWP_OPPORTUNITY_PRESTAGE
