DROP TABLE TELS_CWP_PRODUCTOFFER CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_PRODUCTOFFER
(
...
CREATE UNIQUE INDEX TELS_CWP_PRODUCTOFFR_PK ON TELS_CWP_PRODUCTOFFER
