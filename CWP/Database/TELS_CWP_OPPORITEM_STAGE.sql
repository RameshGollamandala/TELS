DROP TABLE TELS_CWP_OPPORITEM_STAGE CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_OPPORITEM_STAGE
(
...
CREATE UNIQUE INDEX TELS_STAGE_OPPORITEM_PK ON TELS_CWP_OPPORITEM_STAGE
