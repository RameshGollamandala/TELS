DROP TABLE TELS_CWP_SITE_PRESTAGE CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_SITE_PRESTAGE
(
...
CREATE UNIQUE INDEX TELS_PRESTAGE_SITE_PK ON TELS_CWP_SITE_PRESTAGE
