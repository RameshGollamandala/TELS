DROP TABLE TELS_CWP_CUSTOMER_STAGE CASCADE CONSTRAINTS PURGE
/

CREATE TABLE TELS_CWP_CUSTOMER_STAGE
(
...
CREATE UNIQUE INDEX TELS_STAGE_CUST_PK ON TELS_CWP_CUSTOMER_STAGE
