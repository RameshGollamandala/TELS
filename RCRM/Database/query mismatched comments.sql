--Look for records with mismatched comments
...
--    LT2.VALUE LT_PPM_UPSELL_VALUE
   ...
   MMCAO.CONTRACT_START_DATE, MMCDO.CONTRACT_START_DATE, MMCAO.ROW_ID
   , mo.PROMOTION_INTEGRATION_ID, mpam.PRODUCT
FROM 
  MP_OLI MO
  ...
  LEFT JOIN LT_SALES_TYPE_MAIN_PLAN      LT1 ON    LT1.IDX_NAME_0 = NVL(MPAM.ORDER_TYPE,'NULL')    AND LT1.IDX_NAME_1 = NVL(MPAM.ORDER_SUB_TYPE,'NULL') 
...
SELECT
    ...
    ,P1.A94_M, P1.A94_D, ROUND(P1.A94_M + 1) a, ROUND(P1.A94_M) b
...
SELECT * FROM TELS_RCRM_MV_LINE_ITEM WHERE ROW_ID = '1-ONKVLZOL';