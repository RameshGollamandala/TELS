ALTER TABLE TELS_RCRM_PRESTAGE_ROW DROP PRIMARY KEY CASCADE;

DROP TABLE TELS_RCRM_PRESTAGE_ROW CASCADE CONSTRAINTS;

CREATE TABLE TELS_RCRM_PRESTAGE_ROW
(
...
CREATE UNIQUE INDEX TELS_RCRM_PRESTAGE_ROW_PK ON TELS_RCRM_PRESTAGE_ROW
(FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
TABLESPACE TELS_SOURCES;

ALTER TABLE TELS_RCRM_PRESTAGE_ROW ADD (
  CONSTRAINT TELS_RCRM_PRESTAGE_ROW_PK
  PRIMARY KEY
  (FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
  USING INDEX TELS_RCRM_PRESTAGE_ROW_PK);
