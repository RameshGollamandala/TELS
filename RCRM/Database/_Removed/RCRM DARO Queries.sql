...
, DARO AS(
    ...
    UNION
    SELECT * FROM TELS_RCRM_ORDERS_VIEW WHERE REC_TYPE = 'DARO_OLI')
...
FROM 
  ...
  LEFT OUTER JOIN ATTRIBUTES     a5 ON a5.ATTRIBUTE_OWNER_ROW_ID = d.ROW_ID AND a5.ORDER_NUMBER = d.ORDER_NUMBER AND a5.ATTRIBUTE_DISPLAY_NAME = 'Hardware Supplied'
  LEFT OUTER JOIN ATTRIBUTES     a6 ON a6.ATTRIBUTE_OWNER_ROW_ID = d.ROW_ID AND a6.ORDER_NUMBER = d.ORDER_NUMBER AND a6.ATTRIBUTE_DISPLAY_NAME IN('Product Id','Associated Product Part Number')
...
SELECT * FROM TELS_RCRM_ORDERS_VIEW WHERE REC_TYPE = 'DARO_MOLI' AND ORDER_NUMBER = '1-1770180275711';
