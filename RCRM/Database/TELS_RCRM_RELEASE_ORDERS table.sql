...
CREATE UNIQUE INDEX TELS_RCRM_RELEASE_ORDERS ON TELS_RCRM_RELEASE_ORDERS
(FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
TABLESPACE TELS_SOURCES;

ALTER TABLE TELS_RCRM_RELEASE_ORDERS ADD (
  CONSTRAINT TELS_RCRM_RELEASE_ORDERS
  PRIMARY KEY
  (FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
  USING INDEX TELS_RCRM_RELEASE_ORDERS);