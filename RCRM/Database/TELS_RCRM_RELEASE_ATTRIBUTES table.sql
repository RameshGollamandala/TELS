DROP TABLE TELS_RCRM_RELEASE_ATTRIBUTES;

CREATE TABLE TELS_RCRM_RELEASE_ATTRIBUTES (
...
CREATE UNIQUE INDEX TELS_RCRM_RELEASE_ATTRIBUTES ON TELS_RCRM_RELEASE_ATTRIBUTES
(FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
TABLESPACE TELS_SOURCES;

ALTER TABLE TELS_RCRM_RELEASE_ATTRIBUTES ADD (
  CONSTRAINT TELS_RCRM_RELEASE_ATTRIBUTES
  PRIMARY KEY
  (FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
  USING INDEX TELS_RCRM_RELEASE_ATTRIBUTES);