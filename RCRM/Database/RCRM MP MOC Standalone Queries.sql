...
FROM 
  ...
  LEFT OUTER JOIN SERVICE_ASSOC_ACCESS_TYPE_OLI sato ON sato.ORDER_NUMBER = masm.ORDER_NUMBER AND sato.STATUS_HEADER = masm.STATUS_HEADER AND sato.ROOT_ITEM_ROW_ID = masm.ROOT_ITEM_ROW_ID AND sato.ACTION_CODE IN('Add','-')-- AND sato.FILENAME = masm.FILENAME
