...
, PASS1 AS(
    SELECT
      ...
      , CASE WHEN A2.ATTRIBUTE_VALUE IS NOT NULL AND LT1.STRINGVALUE = 'Yes' AND LT2.STRINGVALUE = 'Yes'
             ...
             WHEN MO.HARDWARE_SUPPLIED_FLAG IS NOT NULL 
             THEN MO.HARDWARE_SUPPLIED_FLAG
             ELSE SM.HARDWARE_SUPPLIED_FLAG
             END ATTRIBUTE67
      , '' AS ATTRIBUTE68
...
SELECT
    ...
    CASE WHEN P1.ATTRIBUTE45 = 'Transition' AND PRD.GENERICATTRIBUTE1 = 'Broadband Fixed' AND P1.ATTRIBUTE64 like 'NBN%'
         ...
         END ATTRIBUTE61,
    CASE WHEN P1.ATTRIBUTE45 = 'Transition' AND PRD.GENERICATTRIBUTE1 = 'Broadband Fixed' AND P1.ATTRIBUTE64 like 'NBN%'
         THEN P1.PROCESSED_DATE
         ELSE P1.ATTRIBUTE62
         END ATTRIBUTE62,
    P1.ATTRIBUTE63,P1.ATTRIBUTE64,
    CASE WHEN P1.ATTRIBUTE45 = 'Transition' AND PRD.GENERICATTRIBUTE1 = 'Broadband Fixed' AND P1.ATTRIBUTE64 like 'NBN%'
         THEN '24' 
         ELSE P1.ATTRIBUTE65
         END ATTRIBUTE65,
    P1.ATTRIBUTE66,P1.ATTRIBUTE67,P1.ATTRIBUTE68,P1.ATTRIBUTE69,P1.ATTRIBUTE70,P1.ATTRIBUTE71,P1.ATTRIBUTE72,P1.ATTRIBUTE73,P1.ATTRIBUTE74,P1.ATTRIBUTE75,P1.ATTRIBUTE76,P1.ATTRIBUTE77,
