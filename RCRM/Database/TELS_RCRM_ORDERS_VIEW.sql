...
--    WHERE NOT EXISTS(SELECT 1 FROM TELS_RCRM_HOLD_ORDERS h WHERE h.ROW_ID = d.ROW_ID) --Uncomment this line to prevent hold records from flowing forward
    UNION ALL
    SELECT
        REC_TYPE,
        FILENAME,
