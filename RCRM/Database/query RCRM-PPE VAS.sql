...
SELECT 
    ...
    P1.ATTRIBUTE79,P1.ATTRIBUTE80,P1.ATTRIBUTE81,P1.ATTRIBUTE82,P1.ATTRIBUTE83,P1.ATTRIBUTE84,P1.ATTRIBUTE85,P1.ATTRIBUTE86,P1.ATTRIBUTE87,P1.ATTRIBUTE88,
...
FROM PASS1 P1
JOIN LT_SALES_TYPE_VAS LT ON LT.IDX_NAME_0 = NVL(P1.ATTRIBUTE60,'NULL') AND LT.IDX_NAME_1 = NVL(P1.ATTRIBUTE45,'NULL')
