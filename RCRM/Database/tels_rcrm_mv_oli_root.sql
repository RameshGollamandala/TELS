DROP MATERIALIZED VIEW TELS_RCRM_MV_OLI_ROOT;

DROP TABLE TELS_RCRM_MV_OLI_ROOT CASCADE CONSTRAINTS;

CREATE TABLE TELS_RCRM_MV_OLI_ROOT
(
...
CREATE MATERIALIZED VIEW TELS_RCRM_MV_OLI_ROOT
ON PREBUILT TABLE
REFRESH COMPLETE
ON DEMAND
AS
SELECT
--  CAST('OLI' AS VARCHAR2(255)) AS "REC_TYPE",
  D.FILENAME,
  D.BATCHPROCESSDATE,
...
DROP INDEX TELS_RCRM_MV_OLI_ROOT_IX_1;

CREATE INDEX TELS_RCRM_MV_OLI_ROOT_IX_1 ON TELS_RCRM_MV_OLI_ROOT
(COMMISSION_PRODUCT_TYPE,ACTION_CODE)
TABLESPACE TELS_TRANSFORMS
;

DROP INDEX TELS_RCRM_MV_OLI_ROOT_IX_2;

CREATE INDEX TELS_RCRM_MV_OLI_ROOT_IX_2 ON TELS_RCRM_MV_OLI_ROOT
...
--SELECT * FROM TELS_RCRM_MV_OLI_ROOT;

--CREATE INDEX TELS_RCRM_MV_OLI_PK ON TELS_RCRM_MV_MOLI
