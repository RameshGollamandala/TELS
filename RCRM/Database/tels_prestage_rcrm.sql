ALTER TABLE TELS_PRESTAGE_RCRM DROP PRIMARY KEY CASCADE;

DROP TABLE TELS_PRESTAGE_RCRM CASCADE CONSTRAINTS;

CREATE TABLE TELS_PRESTAGE_RCRM
(
...
CREATE UNIQUE INDEX TELS_PRESTAGE_RCRM_PK ON TELS_PRESTAGE_RCRM
(FILENAME,BATCHPROCESSDATE,RECORDNUMBER)
TABLESPACE TELS_SOURCES;

ALTER TABLE TELS_PRESTAGE_RCRM ADD (
