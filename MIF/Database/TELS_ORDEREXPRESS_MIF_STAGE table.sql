/********************************************************************
  ...
  ********************************************************************/
--DROP TABLE TELS_ORDEREXPRESS_MIF_STAGE;
CREATE TABLE TELS_ORDEREXPRESS_MIF_STAGE
(
    FILENAME                  varchar2(255) NOT NULL,
    RECORDNUMBER              number(10) NOT NULL,
    BATCHPROCESSDATE          varchar2(255),
    IS_FILTERED               varchar2(10),
...
--    RECORDSEQUENCE            number(16),
--    EVENTTYPE                 varchar(40),
--    ORDERLINENUMBER           varchar(40),
--    EFFECTIVEDATE             date,
...
--    BILLINGACCOUNT            varchar(255),
--    COMMISSIONTYPE            varchar(255),
--    COMMISSIONPERCENTAGE      number(25),
--    COMMISSIONTOTAL           number(25),
--    PRODUCTCATEGORY           varchar(255),
...
--    CONTRACTTERM              number(25),
--    PREVIOUSPRODUCTCODE       varchar(255),
--    PREVIOUSMMC               number(25),
--    PREVIOUSCONTRACTSTARTDATE date,
--    PREVIOUSCONTRACTTERM      number(25),
--    ACCESSTYPE                varchar(255),
--    REPAYMENTMETHOD           varchar(255),
--    IMEI_SERIALNO             varchar(255),
--    COSTCENTREOVERRIDE        varchar(255),
...
--    ATTRIBUTEDATE4            date,
--    ATTRIBUTEDATE5            date,
--    ATTRIBUTEBOOLEAN1         number(1),
--    ATTRIBUTEBOOLEAN2         number(1),
--    ATTRIBUTEBOOLEAN3         number(1),
--    ATTRIBUTEBOOLEAN4         number(1),
--    ATTRIBUTEBOOLEAN5         number(1),
--    ATTRIBUTENUM1             number(25),
--    ATTRIBUTENUM2             number(25),
--    ATTRIBUTENUM3             number(25),
--    ATTRIBUTENUM4             number(25),
--    ATTRIBUTENUM5             number(25),
--    ATTRIBUTENUM6             number(25),
--    ATTRIBUTENUM7             number(25),
--    ATTRIBUTENUM8             number(25),
--    ATTRIBUTENUM9             number(25)
--);